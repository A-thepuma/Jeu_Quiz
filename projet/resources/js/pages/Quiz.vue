...
<template>
  <div class="min-h-screen flex flex-col bg-white">
    ...
    <!-- Progress -->
    <div class="w-full h-[2px] bg-gray-100">
    ...
    <main
      class="flex-1 container py-10 md:py-14 max-w-3xl mx-auto px-4"
    >
      ...
      >
        <h1
          class="text-2xl md:text-4xl font-light mb-4"
        >
          No questions found
        </h1>
      ...
      <template v-else>
        ...
        <!-- Meta -->
        <div
          class="flex items-center justify-between mb-10 animate-fade-in"
        >
          ...
          <div>
            ...
            <p
              class="text-[10px] uppercase tracking-[0.2em] text-gray-400 font-light mb-1"
            >
              {{ category.name }}
            </p>
          ...
          <div class="flex items-center gap-5">
            ...
            >
              ...
              <span
                class="text-[10px] uppercase tracking-[0.2em] text-gray-400 font-light"
              >
                Streak
              </span>
            ...
            <div class="relative h-14 w-14">
              ...
              <div
                class="absolute inset-0 flex items-center justify-center text-sm font-light"
              >
                {{ timeLeft }}s
              </div>
        ...
        >
          ...
          <h1
            class="text-2xl md:text-4xl font-light leading-tight mb-10 md:mb-14 text-balance"
          >
            {{ q.text }}
          </h1>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <template
                    v-if="answerState(i) === 'correct'"
                  >
                    ✓
                  </template>

                  <template
                    v-else-if="answerState(i) === 'wrong'"
                  >
                    ✕
                  </template>
                ...
                <!-- Text -->
                <span
                  class="font-light text-base md:text-lg leading-snug"
                >
                  {{ opt }}
                </span>
